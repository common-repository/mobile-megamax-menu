module.exports = function(grunt) {
  ...
  var config = {
    ...
    cssmin: {
      minify: {
        files: {
          'assets/css/megamaxmenu.min.css' : ['assets/css/megamaxmenu.css'],
          'pro/assets/css/megamaxmenu.min.css' : ['pro/assets/css/megamaxmenu.css']
        }
      }
    },
    ...
    //     js: 'assets/js/*.js',
    //     jsOutputFile: 'assets/js/megamaxmenu.min.js',
    //     maxBuffer: 500,
    //     options: {
    ...
    'closure-compiler': {
      megamaxmenujs: {
        files: {
          'assets/js/megamaxmenu.min.js': ['assets/js/megamaxmenu.js']
        },
        options: {
          compilation_level: 'SIMPLE_OPTIMIZATIONS',
          output_wrapper: '',
    ...
    less: {
      development: {
        ...
        files: [
          {
            "assets/css/megamaxmenu.css": "assets/css/megamaxmenu.less"
          },
          {
            "pro/assets/css/megamaxmenu.css": "pro/assets/css/megamaxmenu.less"
          },
      ...
      prefix: {
        ...
        files: [
          //Main File
          {
            "pro/assets/css/megamaxmenu.prefix.css" : "pro/assets/css/prefix.less"
          },
          //Skins
          {
            expand: true,
  ...
  //   files: [
  //     {
  //       "custom/megamaxmenu-prefix.css" : "pro/assets/css/prefix.less"
  //     }
  //   ]
  // };
  //
