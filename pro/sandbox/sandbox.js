(function($){
  ...
  $( '#megamaxmenu-sandbox-preview-form button' ).on( 'click' , function(e){
    e.preventDefault();
    $( '.loading' ).addClass( 'loading-show' );
    var data = {
      'security' : megamaxmenu_sandbox_ajax.security,
  		'action': 'megamaxmenu_sandbox_preview',
    ...
    //console.log( data );
  	$.post( megamaxmenu_sandbox_ajax.ajax_url, data, function(response) {
      $( '.loading' ).removeClass( 'loading-show' );
  		$('#megamaxmenu-sandbox-menu-preview').html( response );
