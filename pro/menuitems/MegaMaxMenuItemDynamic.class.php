...
class MegaMaxMenuItemDynamic extends MegaMaxMenuItem{
...
class MegaMaxMenu_dynamic_item{
...
class MegaMaxMenu_dynamic_term_item extends MegaMaxMenu_dynamic_item{
	var $term_id;
	var $taxonomy_slug;
	var $custom_type = 'dynamic_term_item';
}

class MegaMaxMenu_dynamic_post_item extends MegaMaxMenu_dynamic_item{
	var $dynamic_post_id;
