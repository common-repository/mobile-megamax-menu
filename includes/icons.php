...
function megamaxmenu_register_icons( $group , $iconmap ){
	_MEGAMAXMENU()->register_icons( $group, $iconmap );
}

function megamaxmenu_deregister_icons( $group ){
	_MEGAMAXMENU()->deregister_icons( $group );
}
function megamaxmenu_get_registered_icons(){
	return _MEGAMAXMENU()->get_registered_icons();
}
function megamaxmenu_get_icon_ops(){

	$icons = megamaxmenu_get_registered_icons();
...
function megamaxmenu_register_default_icons(){

	// megamaxmenu_register_icons( 'font-awesome' , array(
	// 	'title' => 'Font Awesome',
	// 	'class_prefix' => 'fa ',
	// 	'iconmap' => megamaxmenu_get_icons()
	// ));

	megamaxmenu_register_icons( 'font-awesome-solid' , array(
		'title' => 'Font Awesome',
		'class_prefix' => 'fas ',
		'iconmap' => megamaxmenu_get_icons()
	));

	megamaxmenu_register_icons( 'font-awesome-regular' , array(
		'title' => 'Font Awesome Regular',
		'class_prefix' => 'far ',
		'iconmap' => megamaxmenu_get_icons_regular()
	));

	megamaxmenu_register_icons( 'font-awesome-brands' , array(
		'title' => 'Font Awesome Brands',
		'class_prefix' => 'fab ',
		'iconmap' => megamaxmenu_get_icons_brands()
	));

}

function megamaxmenu_get_icons_brands(){
	$icons = array(
...
function megamaxmenu_get_icons(){
 ...
 */
function megamaxmenu_get_icons_regular(){

	// $is = megamaxmenu_get_icons();
	// foreach( $is as $name => $data ){
	// 	$name = substr( $name , 3 );
	// 	$prefix = megamaxmenu_fa5free_prefix_map( $name );
	// 	//echo '<br/>'.$prefix;
...
function megamaxmenu_get_meta_value_by_key( $meta_key, $limit = 1 ){
    global $wpdb;
    if (1 == $limit)
 ...
 */
function megamaxmenu_fa5_convert( $fa4icon_class , $return_unchanged_icon_class = false ){

	if( megamaxmenu_op( 'convert_fa4_to_fa5' , 'general' ) == 'off' ){
  ...
  //If the name stays the same, we still need to update the prefix
    ...
    //replace 'fa' with 'fas' or 'fab' or 'far'
		$new_prefix = megamaxmenu_fa5free_prefix_map( $icon_name );
		if( $new_prefix ){
...
function megamaxmenu_fa5free_prefix_map( $icon_name ){
  $map = array(
    '500px' => 'fab',
    'accessible-icon' => 'fab',
    'accusoft' => 'fab',
